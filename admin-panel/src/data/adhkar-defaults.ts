...
export function getDefaultTasbihPresets(): DefaultTasbihPreset[] {
  return [
    { id: 'tasbih_default_1', text: 'سُبْحَانَ اللهِ', transliteration: 'Subhan Allah', target: 33, source: 'hadith_sahih', virtue: 'أحب الكلام إلى الله أربع: سبحان الله، والحمد لله، ولا إله إلا الله، والله أكبر', reference: 'صحيح البخاري ومسلم', order: 0 },
    { id: 'tasbih_default_2', text: 'الْحَمْدُ لِلَّهِ', transliteration: 'Alhamdulillah', target: 33, source: 'hadith_sahih', virtue: 'الحمد لله تملأ الميزان، وسبحان الله والحمد لله تملآن ما بين السموات والأرض', reference: 'صحيح مسلم', order: 1 },
    { id: 'tasbih_default_3', text: 'اللهُ أَكْبَرُ', transliteration: 'Allahu Akbar', target: 33, source: 'hadith_sahih', virtue: 'أحب الكلام إلى الله أربع: سبحان الله، والحمد لله، ولا إله إلا الله، والله أكبر', reference: 'صحيح مسلم', order: 2 },
    { id: 'tasbih_default_4', text: 'لَا إِلَهَ إِلَّا اللهُ', transliteration: 'La ilaha illa Allah', target: 100, source: 'hadith_sahih', virtue: 'أفضل الذكر لا إله إلا الله، وأفضل الدعاء الحمد لله', reference: 'صحيح مسلم', order: 3 },
    ...
    { id: 'tasbih_default_6', text: 'لَا إِلَهَ إِلَّا أَنْتَ سُبْحَانَكَ إِنِّي كُنْتُ مِنَ الظَّالِمِينَ', transliteration: 'La ilaha illa anta subhanaka inni kuntu minaz-zalimin', target: 1, source: 'quran', virtue: 'دعوة ذي النون عليه السلام؛ قال النبي ﷺ: «فإنه لم يدعُ بها رجل مسلم في شيء قط إلا استجاب الله له». ولم يثبت لها عدد مخصوص', reference: 'الأنبياء: 87، وسنن الترمذي 3505', order: 5 },
    { id: 'tasbih_default_7', text: 'سُبْحَانَ اللهِ الْعَظِيمِ وَبِحَمْدِهِ', transliteration: 'Subhan Allahil Azeem wa bihamdih', target: 100, source: 'hadith_sahih', virtue: 'كلمتان خفيفتان على اللسان، ثقيلتان في الميزان، حبيبتان إلى الرحمن: سبحان الله وبحمده، سبحان الله العظيم', reference: 'صحيح البخاري ومسلم', order: 6 },
    { id: 'tasbih_default_8', text: 'لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللهِ', transliteration: 'La hawla wa la quwwata illa billah', target: 100, source: 'hadith_sahih', virtue: 'لا حول ولا قوة إلا بالله كنزٌ من كنوز الجنة', reference: 'متفق عليه', order: 7 },
    { id: 'tasbih_default_9', text: 'أَسْتَغْفِرُ اللهَ', transliteration: 'Astaghfirullah', target: 100, source: 'hadith_sahih', virtue: 'من لزم الاستغفار جعل الله له من كل ضيق مخرجاً، ومن كل همٍّ فرجاً، ورزقه من حيث لا يحتسب', reference: 'صحيح - سنن أبي داود', order: 8 },
    { id: 'tasbih_default_10', text: 'أَسْتَغْفِرُ اللهَ الْعَظِيمَ الَّذِي لَا إِلَهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ وَأَتُوبُ إِلَيْهِ', transliteration: 'Astaghfirullaha al-Azeem alladhi la ilaha illa huwal Hayyul Qayyumu wa atubu ilayh', target: 3, source: 'hadith_hasan', virtue: 'من قال أستغفر الله العظيم الذي لا إله إلا هو الحي القيوم وأتوب إليه، غُفر له وإن كان فرَّ من الزحف', reference: 'حسن - سنن الترمذي', order: 9 },
    { id: 'tasbih_default_11', text: 'سُبْحَانَ اللهِ، وَالْحَمْدُ لِلَّهِ، وَلَا إِلَهَ إِلَّا اللهُ، وَاللهُ أَكْبَرُ', transliteration: 'Subhan Allah, wal hamdulillah, wa la ilaha illa Allah, wallahu Akbar', target: 100, source: 'hadith_sahih', virtue: 'أفضل الكلام بعد القرآن أربع وهي من القرآن: سبحان الله، والحمد لله، ولا إله إلا الله، والله أكبر', reference: 'صحيح مسلم', order: 10 },
    { id: 'tasbih_default_12', text: 'اللَّهُمَّ صَلِّ وَسَلِّمْ عَلَى نَبِيِّنَا مُحَمَّدٍ', transliteration: 'Allahumma salli wa sallim ala nabiyyina Muhammad', target: 100, source: 'hadith_sahih', virtue: 'من صلى عليَّ واحدة صلى الله عليه عشرًا', reference: 'صحيح مسلم', order: 11 },
    { id: 'tasbih_default_13', text: 'رَبِّ اغْفِرْ لِي وَتُبْ عَلَيَّ إِنَّكَ أَنْتَ التَّوَّابُ الرَّحِيمُ', transliteration: 'Rabbi ighfir li wa tub alayya innaka antat-Tawwabur-Rahim', target: 100, source: 'hadith_sahih', virtue: 'رب اغفر لي وتب علي إنك أنت التواب الرحيم — من أفضل أدعية الاستغفار', reference: 'صحيح - سنن الترمذي', order: 12 },
    { id: 'tasbih_default_14', text: 'سُبُّوحٌ قُدُّوسٌ رَبُّ الْمَلَائِكَةِ وَالرُّوحِ', transliteration: 'Subbuhun Quddusun Rabbul malaikati war-ruh', target: 33, source: 'hadith_sahih', virtue: 'سبوح قدوس رب الملائكة والروح — كان النبي ﷺ يقولها في ركوعه وسجوده', reference: 'صحيح مسلم', order: 13 },
    { id: 'tasbih_default_15', text: 'يَا حَيُّ يَا قَيُّومُ بِرَحْمَتِكَ أَسْتَغِيثُ', transliteration: 'Ya Hayyu Ya Qayyum bi rahmatika astaghith', target: 7, source: 'hadith_hasan', virtue: 'يا حي يا قيوم برحمتك أستغيث — يا حي يا قيوم برحمتك أستغيث — من قالها أصلح الله له حاله', reference: 'حسن - سنن الترمذي', order: 14 },
  ];
}
