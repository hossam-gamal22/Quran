...
const ROUTE_OPTIONS = [
  ...
  { value: '/ayat-universe', label: 'آيات الكون' },
  { value: '/hadith-sifat', label: 'أحاديث الصفات' },
  { value: '/widget-settings', label: 'إعدادات الودجات' },
  { value: '/tasbih-stats', label: 'إحصائيات التسبيح' },
  { value: '/honor-board', label: 'لوحة الشرف' },
];
