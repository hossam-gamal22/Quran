...
exports.cleanupFcmPrayerDedupe = exports.sendPrayerPushFallback = exports.processScheduledAdminNotifications = exports.validateAdminSession = exports.verifyAdminPassword = exports.selectMonthlyWinners = exports.answerUserQuestionAutomatically = void 0;
...
function buildAutoQaAnswer(question, sources, extractedContent) {
 ...
 */
function buildGenericSearchLinks(question) {
    ...
    try {
        ...
        if (!hasQuota) {
            await snap.ref.update({
                ...
                autoAnswer: 'نأسف، تم الوصول للحد الرسمي للأسئلة اليوم. يمكنك إرسال سؤالك لنا وسنراجعه ونرد عليك بمصادر موثوقة خلال 48 ساعة إن شاء الله.',
                autoAnswerSources: [],
                autoAnswerCompletedAt: admin.firestore.FieldValue.serverTimestamp(),
            });
            return;
        ...
        if (sources.length === 0) {
            await snap.ref.update({
                ...
                autoAnswer: 'لم نعثر على مصادر كافية للإجابة على هذا السؤال الآن. تم حفظ سؤالك، ويمكنك المحاولة بصياغة أوضح أو الرجوع لأهل العلم.',
                autoAnswerSources: [],
                autoAnswerCompletedAt: admin.firestore.FieldValue.serverTimestamp(),
            });
            return;
