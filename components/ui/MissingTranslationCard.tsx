...
const MESSAGES: Record<string, { body: string; cta: string; subject: string }> = {
  en: { body: 'Some content may be auto-translated. Help us improve!', cta: 'Suggest a correction', subject: 'Translation improvement - Rooh Al-Muslim' },
  fr: { body: 'Certains contenus peuvent être traduits automatiquement. Aidez-nous à améliorer !', cta: 'Suggérer une correction', subject: 'Amélioration de traduction - Rooh Al-Muslim' },
  de: { body: 'Einige Inhalte wurden möglicherweise automatisch übersetzt. Helfen Sie uns, sie zu verbessern!', cta: 'Korrektur vorschlagen', subject: 'Übersetzungsverbesserung - Rooh Al-Muslim' },
  es: { body: 'Algunos contenidos pueden estar traducidos automáticamente. ¡Ayúdanos a mejorar!', cta: 'Sugerir una corrección', subject: 'Mejora de traducción - Rooh Al-Muslim' },
  tr: { body: 'Bazı içerikler otomatik çevrilmiş olabilir. İyileştirmemize yardım edin!', cta: 'Düzeltme önerin', subject: 'Çeviri iyileştirmesi - Rooh Al-Muslim' },
  ...
  id: { body: 'Beberapa konten mungkin diterjemahkan otomatis. Bantu kami memperbaikinya!', cta: 'Sarankan koreksi', subject: 'Perbaikan terjemahan - Rooh Al-Muslim' },
  ms: { body: 'Sesetengah kandungan mungkin diterjemah secara automatik. Bantu kami memperbaikinya!', cta: 'Cadangkan pembetulan', subject: 'Penambahbaikan terjemahan - Rooh Al-Muslim' },
  ...
  ru: { body: 'Некоторый контент может быть переведён автоматически. Помогите нам улучшить!', cta: 'Предложить исправление', subject: 'Улучшение перевода - Rooh Al-Muslim' },
};
