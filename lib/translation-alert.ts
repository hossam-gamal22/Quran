...
const ALERT_MESSAGES: Record<string, {
  ...
  en: {
    ...
    contact: 'Contact Us',
    ok: 'OK',
    subject: 'Content translation request - Rooh Al-Muslim',
  },
  fr: {
    ...
    ok: 'OK',
    subject: 'Demande de traduction - Rooh Al-Muslim',
  },
  de: {
    ...
    ok: 'OK',
    subject: 'Übersetzungsanfrage - Rooh Al-Muslim',
  },
  es: {
    ...
    contact: 'Contáctenos',
    ok: 'OK',
    subject: 'Solicitud de traducción - Rooh Al-Muslim',
  },
  tr: {
    ...
    contact: 'Bize Ulaşın',
    ok: 'Tamam',
    subject: 'Çeviri talebi - Rooh Al-Muslim',
  },
  ur: {
  ...
  id: {
    ...
    ok: 'OK',
    subject: 'Permintaan terjemahan - Rooh Al-Muslim',
  },
  ms: {
  ...
  ru: {
    ...
    ok: 'OK',
    subject: 'Запрос на перевод - Rooh Al-Muslim',
  },
};
