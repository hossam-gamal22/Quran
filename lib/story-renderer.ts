  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header {
      text-align: center;
      padding: 30px 0;
      border-bottom: 2px solid #0d8e62;
      margin-bottom: 30px;
    }
    .header .icon { font-size: 60px; margin-bottom: 10px; }
    .header h1 { font-size: 28px; color: #0d8e62; }
    ...
    .toc h2 { font-size: 18px; margin-bottom: 12px; color: #0d8e62; }
    .toc a {
    ...
    .lessons h3 { color: #0d8e62; margin-bottom: 12px; font-size: 18px; }
    ...
    .lessons li::before {
      ...
      right: 0; color: #0d8e62;
    }
    .footer {
      text-align: center; padding: 24px 0; margin-top: 32px;
      border-top: 2px solid #0d8e62; color: ${mutedColor};
    }
    .footer .app-name { font-size: 18px; color: #0d8e62; margin-bottom: 4px; }
  </style>
</head>
<body>
  ${content}
