...
.header{
  background:linear-gradient(160deg,#052e23 0%,#0b513f 40%,#0d8e62 100%);
...
.step-num{background:#0d8e62;box-shadow:0 2px 6px rgba(15,152,127,0.3);}
...
.footer{
  ...
  background:linear-gradient(160deg,#052e23 0%,#0b513f 50%,#0d8e62 100%);
